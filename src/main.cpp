...
uint256 hashGenesisBlock("0x6aef75c5cf43804e38967ba414ab8225b9605c234a3f84f93faeec41de5727d5");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 6); // Abccoin: starting difficulty is 1 / 2^12
...
{
    // Abccoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Abccoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Clonecoin: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // Abccoin: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Abccoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6aef75c5cf43804e38967ba414ab8225b9605c234a3f84f93faeec41de5727d5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "CNN 22/12/2019 Brexit was a distraction. Now Europe is facing a hellish 2020";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("047a4d874802f35c72440411ee18a963f9a76b2169164f7da40416a9fdf12b1180809eec8494abc25ab2b11613410540602d95fee5b8d17759618cea24e2e52bad") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1576972916;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1192418;
        ...
        assert(block.hashMerkleRoot == uint256("0x05fd798bf4b07c0b3b3d7db5be0372a14a780910faffa4711743f3a0c4fc208b"));
...
unsigned char pchMessageStart[4] = { 0xb2, 0x3a, 0xf3, 0x1a }; // Abccoin: increase each by adding 2 to bitcoin's value.
...
void static AbccoinMiner(CWallet *pwallet)
{
    printf("AbccoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("abccoin-miner");
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AbccoinMiner, pwallet));
}
